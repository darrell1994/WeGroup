...
//        timer.invalidate()
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        if let currentContact = Contact.currentContact {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Purdue-University.coreDataTest" in the application's documents Application Support directory.
